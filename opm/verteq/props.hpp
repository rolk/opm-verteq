...
struct VertEqProps : public IncompPropertiesInterface {
	 ...
	 *
	 * @param mapping Helper object to map between columns in the coarse
	 * grid and elements in the fine grid.
	 ...
	 */
	static VertEqProps* create (const UpscaleMapping& mapping,
